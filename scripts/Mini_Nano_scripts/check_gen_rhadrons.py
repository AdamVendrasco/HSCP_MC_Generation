...
THRESH = 1_000_000
MAX_EVENTS_TO_PRINT = 5

NBINS = 40
PT_MIN, PT_MAX   = 0.0, 2000.0
...
def draw_single(name, xmin, xmax, h, xtitle, ytitle, outpng, yoffset=1.45, titlesize=0.045, labelsize=0.040):
    ymax = max(h.GetMaximum(), 1.0) * 1.35
    canv = CMS.cmsCanvas(name, xmin, xmax, 0.0, ymax, xtitle, ytitle, square=False, iPos=11)
...
def draw_overlay(name, xmin, xmax, h1, h2, xtitle, ytitle, outpng, yoffset=1.45, titlesize=0.045, labelsize=0.040):
