...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('root://cmseos.fnal.gov//store/user/avendras/HSCP/gridpack_output/tarballs/RunII/ms-Rhadron_mstop_2000_slc7_amd64_gcc700_CMSSW_10_6_47_xqcut110_tarball.tar.xz'),
...
generator = cms.EDFilter("Pythia8HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            'JetMatching:qCut = 110.', #this is the actual merging scale
