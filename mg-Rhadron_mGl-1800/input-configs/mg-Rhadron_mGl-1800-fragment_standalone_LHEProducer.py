...
#      
#      'JetMatching:setMad = on', ####-----> ADDED THIS! Switched this to on. When enabled, 
#                                 ####-----> the merging parameters are set according to the values in the LHEF header. 
#        
#      # Scheme and Usage
#      'JetMatching:scheme = 1',
#      'JetMatching:merge = on',  ####-----> ADDED THIS! This is the master switch for parton jet matching.
#      
#      # Jet algorithm
