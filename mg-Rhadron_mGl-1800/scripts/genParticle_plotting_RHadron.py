...
# ========================================
OUTPUT_DIRECTORY = "/eos/home-a/avendras/mg-Rhadron_v6/plot_archive/gen_RHadron_1800_JetMatching_ON/"
ROOT_FILE_PATH = "/eos/user/a/avendras/mg-Rhadron_v6/mg-Rhadron_mGl-1800/root-files/mg-Rhadron_mGl-1800-CMSSW_13_2_9-n1000-Jet_matching_ON-100.root"
...
def inspect_gen_particles(event_index=0):
    ...
    """
    gen_branch = tree.GetBranch("recoGenParticles_genParticles__GEN.")
    if gen_branch:
        print("\nFound branch using GetBranch:", gen_branch.GetName())
    ...
    tree.SetBranchStatus("recoGenParticles_genParticles__GEN.", 1)
