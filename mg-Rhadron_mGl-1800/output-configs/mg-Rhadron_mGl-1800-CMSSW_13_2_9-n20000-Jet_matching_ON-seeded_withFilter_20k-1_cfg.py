...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/eos/user/a/avendras/mg-Rhadron_v6/mg-Rhadron_mGl-1800/root-files/mg-Rhadron_mGl-1800-CMSSW_13_2_9-n20000-Jet_matching_ON-seeded_withFilter_20k.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/eos/user/a/avendras/mg-Rhadron_v6/mg-Rhadron_mGl-1800/root-files/mg-Rhadron_mGl-1800-CMSSW_13_2_9-n20000-Jet_matching_ON-seeded_withFilter_20k_inLHE.root'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    ...
    #Added custom user hook for getting pythia xml
    #userHooks = cms.VPSet(
    #    cms.PSet(
    #        pluginName = cms.string("MyUserHook"),
    #        outputFile = cms.string("particles.xml")
    #    
    #    )
    #)   
)
