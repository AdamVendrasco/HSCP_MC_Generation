...
# with command line options: Configuration/GenProduction/python/mg-Rhadron_mGl-1800-fragment_Jet_matching_ON.py --python_filename /afs/cern.ch/user/a/avendras/work/mg-Rhadron/mg-Rhadron_mGl-1800/output-configs/mg-Rhadron_mGl-1800-CMSSW_13_2_9-n1-Jet_matching_ON-testing_new_ouptut-1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --customise_commands             process.load('IOMC.RandomEngine.IOMC_cff');             process.RandomNumberGeneratorService.generator.initialSeed = cms.untracked.uint32(123456789);             process.RandomNumberGeneratorService.g4SimHits.initialSeed = cms.untracked.uint32(987654321);             process.RandomNumberGeneratorService.VtxSmeared.initialSeed = cms.untracked.uint32(192837465);             process.rndmStore = cms.EDProducer('RandomEngineStateProducer') --datatier GEN,LHE --fileout file:/eos/user/a/avendras/testoutput/mg-Rhadron_mGl-1800-CMSSW_13_2_9-n1-Jet_matching_ON-testing_new_ouptut.root --conditions 106X_upgrade2018_realistic_v4 --beamspot Realistic25ns13TeVEarly2018Collision --step LHE,GEN --geometry DB:Extended --era Run2_2018 --mc -n 1
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/eos/user/a/avendras/testoutput/mg-Rhadron_mGl-1800-CMSSW_13_2_9-n1-Jet_matching_ON-testing_new_ouptut.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/eos/user/a/avendras/testoutput/mg-Rhadron_mGl-1800-CMSSW_13_2_9-n1-Jet_matching_ON-testing_new_ouptut_inLHE.root'),
