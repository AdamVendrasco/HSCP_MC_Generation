...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/mg-Rhadron_mGl-1800-fragment_Jet_matching_ON.py nevts:1000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/eos/user/a/avendras/gridpack_output/HSCP/mg-Rhadron_mGl-1800/root_files/mg-Rhadron_mGl-1800-CMSSW_13_2_9-n1000-Jet_matching_ON-1k_60qcut_newFragment.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/eos/user/a/avendras/gridpack_output/HSCP/mg-Rhadron_mGl-1800/root_files/mg-Rhadron_mGl-1800-CMSSW_13_2_9-n1000-Jet_matching_ON-1k_60qcut_newFragment_inLHE.root'),
