...
# with command line options: Configuration/GenProduction/python/mg-Rhadron_mGl-1800-fragment_Jet_matching_ON.py --python_filename /eos/user/a/avendras/mg-Rhadron_v6/mg-Rhadron_mGl-1800/output-configs/mg-Rhadron_mGl-1800-CMSSW_13_2_9-n100-Jet_matching_ON-new_eostest-GEN-SIM_cfg.py --eventcontent FEVTDEBUG,LHE --customise Configuration/DataProcessing/Utils.addMonitoring,Configuration/GenProduction/CustomRhadron.addCustomisation --nThreads 1 --datatier GEN-SIM,LHE --fileout file:/eos/user/a/avendras/gridpack_output/HSCP/mg-Rhadron_mGl-1800/root_files/mg-Rhadron_mGl-1800-CMSSW_13_2_9-n100-Jet_matching_ON-new_eostest-GEN-SIM.root --conditions 106X_upgrade2018_realistic_v4 --beamspot Realistic25ns13TeVEarly2018Collision --step LHE,GEN,SIM --geometry DB:Extended --era Run2_2018 --mc -n 100
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/eos/user/a/avendras/gridpack_output/HSCP/mg-Rhadron_mGl-1800/root_files/mg-Rhadron_mGl-1800-CMSSW_13_2_9-n100-Jet_matching_ON-new_eostest-GEN-SIM.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/eos/user/a/avendras/gridpack_output/HSCP/mg-Rhadron_mGl-1800/root_files/mg-Rhadron_mGl-1800-CMSSW_13_2_9-n100-Jet_matching_ON-new_eostest-GEN-SIM_inLHE.root'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    ...
    UserCustomization = cms.VPSet(
        ...
        cms.PSet(
            pluginName = cms.string('DumpPythia8RhadronData_Full')
        )
    ),
...
# Automatic addition of the customisation function from Configuration.GenProduction.CustomRhadron
from Configuration.GenProduction.CustomRhadron import addCustomisation 

#call to customisation function addCustomisation imported from Configuration.GenProduction.CustomRhadron
