...
# with command line options: Configuration/GenProduction/python/mg-Rhadron_mGl-1800-fragment_Jet_matching_ON.py --python_filename /eos/user/a/avendras/mg-Rhadron_v6/mg-Rhadron_mGl-1800/output-configs/mg-Rhadron_mGl-1800-CMSSW_13_2_9-n20000-Jet_matching_ON-20k_120qcut_newFragment-1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --customise_commands             process.load('IOMC.RandomEngine.IOMC_cff');             process.RandomNumberGeneratorService.generator.initialSeed = cms.untracked.uint32(123456789);             process.RandomNumberGeneratorService.g4SimHits.initialSeed = cms.untracked.uint32(987654321);             process.RandomNumberGeneratorService.VtxSmeared.initialSeed = cms.untracked.uint32(192837465);             process.rndmStore = cms.EDProducer('RandomEngineStateProducer') --datatier GEN,LHE --fileout file:/eos/user/a/avendras/gridpack_output/HSCP/mg-Rhadron_mGl-1800/root_files/mg-Rhadron_mGl-1800-CMSSW_13_2_9-n20000-Jet_matching_ON-20k_120qcut_newFragment.root --conditions 106X_upgrade2018_realistic_v4 --beamspot Realistic25ns13TeVEarly2018Collision --step LHE,GEN --geometry DB:Extended --era Run2_2018 --mc -n 20000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/mg-Rhadron_mGl-1800-fragment_Jet_matching_ON.py nevts:20000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/eos/user/a/avendras/gridpack_output/HSCP/mg-Rhadron_mGl-1800/root_files/mg-Rhadron_mGl-1800-CMSSW_13_2_9-n20000-Jet_matching_ON-20k_120qcut_newFragment.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/eos/user/a/avendras/gridpack_output/HSCP/mg-Rhadron_mGl-1800/root_files/mg-Rhadron_mGl-1800-CMSSW_13_2_9-n20000-Jet_matching_ON-20k_120qcut_newFragment_inLHE.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/eos/user/a/avendras/gridpack_output/HSCP/mg-Rhadron_mGl-1800/tarball/mg-Rhadron_mGl-1800_el9_amd64_gcc11_CMSSW_13_2_9_tarball_120.tar.xz'),
